...
void PlayScene::update()
{
	...
	m_getTile(7, 3)->setTileCost(100);
	m_getTile(8, 3)->setTileCost(100);
	m_getTile(9, 3)->setTileCost(100);
	m_getTile(10, 3)->setTileCost(100);

	m_getTile(7, 4)->setTileCost(100);
	m_getTile(8, 4)->setTileCost(100);
	m_getTile(9, 4)->setTileCost(100);
	m_getTile(10, 4)->setTileCost(100);

	m_getTile(10, 7)->setTileCost(100);
	m_getTile(11, 7)->setTileCost(100);
	m_getTile(12, 7)->setTileCost(100);
	m_getTile(13, 7)->setTileCost(100);
	m_getTile(14, 7)->setTileCost(100);

	m_getTile(10, 8)->setTileCost(100);
	m_getTile(11, 8)->setTileCost(100);
	m_getTile(12, 8)->setTileCost(100);
	m_getTile(13, 8)->setTileCost(100);
	m_getTile(14, 8)->setTileCost(100);

	if (m_getTile(m_pShip->getGridPosition().x, m_pShip->getGridPosition().y)->getTileCost() == 0.0f)
	{
		SoundManager::Instance().playSound("select_sound", 0, 1);
...
void PlayScene::start()
{
	...
	SoundManager::Instance().load("../Assets/audio/HappyMusic.mp3", "bkgMusic", SOUND_MUSIC);
	SoundManager::Instance().load("../Assets/audio/IWantItThatYay.wav", "select_sound", SOUND_SFX);

	const SDL_Color blue = { 0, 0, 255, 255 };
	m_pLabel1 = new Label("Hold D to toggle debug menu", "Consolas", 20, blue, glm::vec2(960.0f, 40.0f));
	m_pLabel1->setParent(this);
	addChild(m_pLabel1);
	m_pLabel2 = new Label("Press F to find the shortest path", "Consolas", 20, blue, glm::vec2(990.0f, 60.0f));
	m_pLabel2->setParent(this);
	addChild(m_pLabel2);
	m_pLabel3 = new Label("Press R to travel to the destination", "Consolas", 20, blue, glm::vec2(1000.0f, 80.0f));
	...
	m_pTarget->getTransform()->position = m_getTile(15, 12)->getTransform()->position + offset;
	m_pTarget->setGridPosition(15, 12);
	m_getTile(15, 12)->setTileStatus(GOAL);
	addChild(m_pTarget);
